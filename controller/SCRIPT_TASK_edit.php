...
require_once("include/SCRIPT_TASK_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "SCRIPT_TASK_edit";
...
$page_layouts["SCRIPT_TASK_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "SCRIPT_TASK_list";
...
$page_layouts["SCRIPT_TASK_list"] = $layout;
...
$keys = array();
$keys["SCRTAS_UID"] = postvalue("editid1");
