...
require_once("include/DASHBOARD_DAS_IND_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "DASHBOARD_DAS_IND_edit";
...
$page_layouts["DASHBOARD_DAS_IND_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "DASHBOARD_DAS_IND_list";
...
$page_layouts["DASHBOARD_DAS_IND_list"] = $layout;
...
$keys = array();
$keys["DAS_UID"] = postvalue("editid1");
$keys["OWNER_UID"] = postvalue("editid2");
