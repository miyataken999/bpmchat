...
require_once("include/MESSAGE_APPLICATION_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "MESSAGE_APPLICATION_edit";
...
$page_layouts["MESSAGE_APPLICATION_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "MESSAGE_APPLICATION_list";
...
$page_layouts["MESSAGE_APPLICATION_list"] = $layout;
...
$keys = array();
$keys["MSGAPP_UID"] = postvalue("editid1");
