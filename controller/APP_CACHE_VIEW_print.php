...
require_once("include/APP_CACHE_VIEW_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "APPLICATION_masterprint";
...
$page_layouts["APPLICATION_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "APP_CACHE_VIEW" );
