...
require_once("include/OAUTH_REFRESH_TOKENS_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "OAUTH_REFRESH_TOKENS_edit";
...
$page_layouts["OAUTH_REFRESH_TOKENS_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "OAUTH_REFRESH_TOKENS_list";
...
$page_layouts["OAUTH_REFRESH_TOKENS_list"] = $layout;
...
$keys = array();
$keys["REFRESH_TOKEN"] = postvalue("editid1");
