...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "RBAC_ROLES_print";
...
$page_layouts["RBAC_ROLES_print"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "RBAC_USERS_ROLES_print";
$layout->blocks["top"] = array();
$layout->containers["pdf"] = array();
$layout->container_properties["pdf"] = array(  "print" => "none"  );
$layout->containers["pdf"][] = array("name"=>"printbuttons",
...
$layout->blocks["top"][] = "grid";
$page_layouts["RBAC_USERS_ROLES_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "RBAC_ROLES" );
