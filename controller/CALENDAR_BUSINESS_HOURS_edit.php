...
require_once("include/CALENDAR_BUSINESS_HOURS_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "CALENDAR_BUSINESS_HOURS_edit";
...
$page_layouts["CALENDAR_BUSINESS_HOURS_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "CALENDAR_BUSINESS_HOURS_list";
...
$page_layouts["CALENDAR_BUSINESS_HOURS_list"] = $layout;
...
$keys = array();
$keys["CALENDAR_UID"] = postvalue("editid1");
$keys["CALENDAR_BUSINESS_DAY"] = postvalue("editid2");
$keys["CALENDAR_BUSINESS_START"] = postvalue("editid3");
$keys["CALENDAR_BUSINESS_END"] = postvalue("editid4");
