...
require_once("include/ADDONS_MANAGER_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "ADDONS_MANAGER_edit";
...
$page_layouts["ADDONS_MANAGER_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "ADDONS_MANAGER_list";
...
$page_layouts["ADDONS_MANAGER_list"] = $layout;
...
$keys = array();
$keys["ADDON_ID"] = postvalue("editid1");
$keys["STORE_ID"] = postvalue("editid2");
