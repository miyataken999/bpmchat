...
require_once("include/LEXICO_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "LEXICO_edit";
...
$page_layouts["LEXICO_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "LEXICO_list";
...
$page_layouts["LEXICO_list"] = $layout;
...
$keys = array();
$keys["LEX_TOPIC"] = postvalue("editid1");
$keys["LEX_KEY"] = postvalue("editid2");
