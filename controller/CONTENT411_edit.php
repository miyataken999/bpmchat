...
require_once("include/CONTENT411_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "CONTENT411_edit";
...
$page_layouts["CONTENT411_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "CONTENT411_list";
...
$page_layouts["CONTENT411_list"] = $layout;
...
$keys = array();
$keys["CON_CATEGORY"] = postvalue("editid1");
$keys["CON_PARENT"] = postvalue("editid2");
$keys["CON_ID"] = postvalue("editid3");
$keys["CON_LANG"] = postvalue("editid4");
