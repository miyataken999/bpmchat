...
require_once("include/ppmain_variables.php");
...
$layout = new TLayout("Paypalppmain_list", "OfficeBlueWave", "MobileBlueWave");
$layout->version = 2;
...
$layout->containers["bigblock"][] = array("name"=>"wrapper",
	"block"=>"", "substyle"=>2 , "container"=>"recordcontrols" );
...
$layout->containers["bigblock"][] = array("name"=>"wrapper",
	"block"=>"", "substyle"=>2 , "container"=>"message" );
...
$layout->containers["bigblock"][] = array("name"=>"wrapper",
	"block"=>"", "substyle"=>2 , "container"=>"grid" );
...
$layout->containers["bigblock"][] = array("name"=>"wrapper",
	"block"=>"", "substyle"=>2 , "container"=>"pagination" );
...
$layout->containers["left"][] = array("name"=>"",
	"block"=>"", "substyle"=>1  );
...
$page_layouts["ppmain_list"] = $layout;
