...
require_once("include/wpfg_usermeta_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "wpfg_usermeta_edit";
...
$page_layouts["wpfg_usermeta_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "wpfg_usermeta_list";
...
$page_layouts["wpfg_usermeta_list"] = $layout;
...
$keys = array();
$keys["umeta_id"] = postvalue("editid1");
