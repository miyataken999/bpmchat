...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "RBAC_ROLES_PERMISSIONS_edit";
...
$page_layouts["RBAC_ROLES_PERMISSIONS_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "RBAC_ROLES_PERMISSIONS_list";
...
$page_layouts["RBAC_ROLES_PERMISSIONS_list"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "RBAC_ROLES_masterlist";
...
$page_layouts["RBAC_ROLES_masterlist"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "RBAC_PERMISSIONS_masterlist";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
$layout->container_properties["column"] = array(  );
$layout->containers["column"][] = array("name"=>"masterlistheader",
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["RBAC_PERMISSIONS_masterlist"] = $layout;
...
$keys = array();
$keys["ROL_UID"] = postvalue("editid1");
$keys["PER_UID"] = postvalue("editid2");
