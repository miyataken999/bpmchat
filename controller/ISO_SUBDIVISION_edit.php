...
require_once("include/ISO_SUBDIVISION_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "ISO_SUBDIVISION_edit";
...
$page_layouts["ISO_SUBDIVISION_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "ISO_SUBDIVISION_list";
...
$page_layouts["ISO_SUBDIVISION_list"] = $layout;
...
$keys = array();
$keys["IC_UID"] = postvalue("editid1");
$keys["IS_UID"] = postvalue("editid2");
