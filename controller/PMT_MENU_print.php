...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "PMT_MENU_print";
...
$page_layouts["PMT_MENU_print"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "ABE_REQUESTS_masterprint";
...
$page_layouts["ABE_REQUESTS_masterprint"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "PMT_MENU1_print";
$layout->blocks["top"] = array();
$layout->containers["pdf"] = array();
$layout->container_properties["pdf"] = array(  "print" => "none"  );
$layout->containers["pdf"][] = array("name"=>"printbuttons",
...
$layout->blocks["top"][] = "grid";
$page_layouts["PMT_MENU1_print"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "ABE_CONFIGURATION_print";
$layout->blocks["top"] = array();
$layout->containers["pdf"] = array();
$layout->container_properties["pdf"] = array(  "print" => "none"  );
$layout->containers["pdf"][] = array("name"=>"printbuttons",
...
$layout->blocks["top"][] = "grid";
$page_layouts["ABE_CONFIGURATION_print"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "PMT_COMMAND_print";
$layout->blocks["top"] = array();
$layout->containers["pdf"] = array();
$layout->container_properties["pdf"] = array(  "print" => "none"  );
$layout->containers["pdf"][] = array("name"=>"printbuttons",
...
$layout->blocks["top"][] = "grid";
$page_layouts["PMT_COMMAND_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "PMT_MENU" );
