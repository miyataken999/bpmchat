...
require_once("include/DIM_TIME_DELEGATE_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "DIM_TIME_DELEGATE_edit";
...
$page_layouts["DIM_TIME_DELEGATE_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "DIM_TIME_DELEGATE_list";
...
$page_layouts["DIM_TIME_DELEGATE_list"] = $layout;
...
$keys = array();
$keys["TIME_ID"] = postvalue("editid1");
