...
require_once("include/modx_site_content_variables.php");
...
$layout = new TLayout("edit_bootstrap_2col", "OfficeBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "modx_site_content_edit";
...
$page_layouts["modx_site_content_edit"] = $layout;
...
$layout = new TLayout("list_bootstrap1", "OfficeBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "modx_site_content_list";
...
$page_layouts["modx_site_content_list"] = $layout;
...
$layout = new TLayout("tab_bootstrap", "OfficeBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "modx_site_content_edit_New_tab11";
...
$page_layouts["modx_site_content_edit_New_tab11"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "modx_site_content_edit_New_tab1";
$layout->blocks["bare"] = array();
$layout->containers["tabfields"] = array();
$layout->container_properties["tabfields"] = array(  );
$layout->containers["tabfields"][] = array("name"=>"bstabfields",
...
$layout->blocks["bare"][] = "tabfields";
$page_layouts["modx_site_content_edit_New_tab1"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "modx_site_content_edit_New_tab21";
$layout->blocks["bare"] = array();
$layout->containers["tabfields"] = array();
$layout->container_properties["tabfields"] = array(  );
$layout->containers["tabfields"][] = array("name"=>"bstabfields",
...
$layout->blocks["bare"][] = "tabfields";
$page_layouts["modx_site_content_edit_New_tab21"] = $layout;
...
$layout = new TLayout("list_bootstrap3", "OfficeBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "modx_site_templates_list";
$layout->blocks["center"] = array();
$layout->containers["center"] = array();
$layout->container_properties["center"] = array(  );
$layout->containers["center"][] = array("name"=>"wrapper",
...
$page_layouts["modx_site_templates_list"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "modx_site_snippets_list";
$layout->blocks["center"] = array();
$layout->containers["center"] = array();
$layout->container_properties["center"] = array(  );
$layout->containers["center"][] = array("name"=>"wrapper",
...
$layout->blocks["topmiddle"][] = "gridcontrols";
$page_layouts["modx_site_snippets_list"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "modx_site_htmlsnippets_list";
$layout->blocks["center"] = array();
$layout->containers["center"] = array();
$layout->container_properties["center"] = array(  );
$layout->containers["center"][] = array("name"=>"wrapper",
...
$layout->blocks["topmiddle"][] = "gridcontrols";
$page_layouts["modx_site_htmlsnippets_list"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "modx_site_content_child_list";
$layout->blocks["center"] = array();
$layout->containers["messagerow"] = array();
$layout->container_properties["messagerow"] = array(  );
$layout->containers["messagerow"][] = array("name"=>"wrapper",
...
$layout->blocks["topmiddle"][] = "masterinfo";
$page_layouts["modx_site_content_child_list"] = $layout;
