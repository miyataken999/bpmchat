...
require_once("include/MESSAGE_EVENT_RELATION_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "MESSAGE_EVENT_RELATION_edit";
...
$page_layouts["MESSAGE_EVENT_RELATION_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "MESSAGE_EVENT_RELATION_list";
...
$page_layouts["MESSAGE_EVENT_RELATION_list"] = $layout;
...
$keys = array();
$keys["MSGER_UID"] = postvalue("editid1");
