...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("items" == $this->chrt_array['tables'][0])
			return true;
		if("ppmain" == $this->chrt_array['tables'][0])
			return true;
		if("pppaypal_info" == $this->chrt_array['tables'][0])
			return true;
		if("ppmain" == $this->chrt_array['tables'][0])
			return true;
		if("ppsubcategory" == $this->chrt_array['tables'][0])
			return true;
		if("ppusers" == $this->chrt_array['tables'][0])
			return true;
		if("ppcategory" == $this->chrt_array['tables'][0])
			return true;
		if("ppcategory" == $this->chrt_array['tables'][0])
			return true;
		if("API" == $this->chrt_array['tables'][0])
			return true;
		if("CALENDAR_ASSIGNMENTS" == $this->chrt_array['tables'][0])
			return true;
		if("CALENDAR_BUSINESS_HOURS" == $this->chrt_array['tables'][0])
			return true;
		if("CALENDAR_DEFINITION" == $this->chrt_array['tables'][0])
			return true;
		if("CALENDAR_HOLIDAYS" == $this->chrt_array['tables'][0])
			return true;
		if("GATEWAY" == $this->chrt_array['tables'][0])
			return true;
		if("GMAIL_RELABELING" == $this->chrt_array['tables'][0])
			return true;
		if("HOLIDAY" == $this->chrt_array['tables'][0])
			return true;
		if("MESSAGE_TYPE_VARIABLE" == $this->chrt_array['tables'][0])
			return true;
		if("NOTIFICATION_DEVICE" == $this->chrt_array['tables'][0])
			return true;
		if("NOTIFICATION_QUEUE" == $this->chrt_array['tables'][0])
			return true;
		if("OAUTH_ACCESS_TOKENS" == $this->chrt_array['tables'][0])
			return true;
		if("OAUTH_AUTHORIZATION_CODES" == $this->chrt_array['tables'][0])
			return true;
		if("OAUTH_CLIENTS" == $this->chrt_array['tables'][0])
			return true;
		if("OAUTH_REFRESH_TOKENS" == $this->chrt_array['tables'][0])
			return true;
		if("OAUTH_SCOPES" == $this->chrt_array['tables'][0])
			return true;
		if("OBJECT_PERMISSION" == $this->chrt_array['tables'][0])
			return true;
		if("OUTPUT_DOCUMENT" == $this->chrt_array['tables'][0])
			return true;
		if("PMOAUTH_USER_ACCESS_TOKENS" == $this->chrt_array['tables'][0])
			return true;
		if("SESSION_STORAGE" == $this->chrt_array['tables'][0])
			return true;
		if("SHADOW_TABLE" == $this->chrt_array['tables'][0])
			return true;
		if("APP_ASSIGN_SELF_SERVICE_VALUE_GROUP" == $this->chrt_array['tables'][0])
			return true;
		if("modxdf_site_templates" == $this->chrt_array['tables'][0])
			return true;
		if("modxdf_site_snippets" == $this->chrt_array['tables'][0])
			return true;
		if("modxdf_site_plugins" == $this->chrt_array['tables'][0])
			return true;
		if("modxdf_site_content" == $this->chrt_array['tables'][0])
			return true;
		if("modxdf_site_htmlsnippets" == $this->chrt_array['tables'][0])
			return true;
		if("modxdf_site_tmplvars" == $this->chrt_array['tables'][0])
			return true;
		if("WEBSOCKET" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_TEST_BUSINESS_3" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_SITE_REGISTRATION" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("HITWORD" == $this->chrt_array['tables'][0])
			return true;
		if("PLUGINS" == $this->chrt_array['tables'][0])
			return true;
		if("TABLESPACES" == $this->chrt_array['tables'][0])
			return true;
		if("TABLE_CONSTRAINTS" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_SITE" == $this->chrt_array['tables'][0])
			return true;
		if("wpfg_commentmeta" == $this->chrt_array['tables'][0])
			return true;
		if("wpfg_comments" == $this->chrt_array['tables'][0])
			return true;
		if("wpfg_links" == $this->chrt_array['tables'][0])
			return true;
		if("wpfg_options" == $this->chrt_array['tables'][0])
			return true;
		if("wpfg_postmeta" == $this->chrt_array['tables'][0])
			return true;
		if("wpfg_posts" == $this->chrt_array['tables'][0])
			return true;
		if("wpfg_term_relationships" == $this->chrt_array['tables'][0])
			return true;
		if("wpfg_term_taxonomy" == $this->chrt_array['tables'][0])
			return true;
		if("wpfg_termmeta" == $this->chrt_array['tables'][0])
			return true;
		if("wpfg_terms" == $this->chrt_array['tables'][0])
			return true;
		if("wpfg_usermeta" == $this->chrt_array['tables'][0])
			return true;
		if("wpfg_users" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_ANNUAL_REVENUE" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_TEST_BUSINESS" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_SAGAWA" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_RESIDENTS_BASIC_ATTRIBUTES" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_QUOTE" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_SUBCONTRACTORS" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_MITUMORI1" == $this->chrt_array['tables'][0])
			return true;
		if("BPMBOXTRANS" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("APPLICATION" == $this->chrt_array['tables'][0])
		...
		if("ROUTINES" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_INVOICE" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_INVOICE_ITEMS" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_TEST_SCREEN" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_SPREADMAIN" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_SPREADSUB" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_PROGRAM_LIST" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_PMSEIKYUUSHO" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_MST_BRMS" == $this->chrt_array['tables'][0])
			return true;
		if("PMT_QUOTE_DETAILS" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
