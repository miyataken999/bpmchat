...
require_once("include/APPLICATION_Report_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "APPLICATION_Report_rprint";
...
$page_layouts["APPLICATION_Report_rprint"] = $layout;
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=APPLICATION_Report.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
