...
require_once("include/LIST_PARTICIPATED_LAST_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "LIST_PARTICIPATED_LAST_edit";
...
$page_layouts["LIST_PARTICIPATED_LAST_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "LIST_PARTICIPATED_LAST_list";
...
$page_layouts["LIST_PARTICIPATED_LAST_list"] = $layout;
...
$keys["USR_UID"] = postvalue("editid2");
$keys["DEL_INDEX"] = postvalue("editid3");
