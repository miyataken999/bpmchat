...
require_once("include/wpfg_term_relationships_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "wpfg_term_relationships_edit";
...
$page_layouts["wpfg_term_relationships_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "wpfg_term_relationships_list";
...
$page_layouts["wpfg_term_relationships_list"] = $layout;
...
$keys = array();
$keys["object_id"] = postvalue("editid1");
$keys["term_taxonomy_id"] = postvalue("editid2");
