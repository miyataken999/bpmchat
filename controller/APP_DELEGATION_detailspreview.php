...
require_once("include/APP_DELEGATION_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "APP_DELEGATION_detailspreview";
...
$page_layouts["APP_DELEGATION_detailspreview"] = $layout;
...
if($rowcount) 
{
	...
	//	DEL_PREVIOUS - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("DEL_PREVIOUS", $data, $keylink);
			$row["DEL_PREVIOUS_value"] = $value;
			$format = $pSet->getViewFormat("DEL_PREVIOUS");
			$class = "rnr-field-text";
			if($format==FORMAT_FILE) 
				$class = ' rnr-field-file'; 
			if($format==FORMAT_AUDIO)
			...
			if($format==FORMAT_CHECKBOX)
				$class = ' rnr-field-checkbox';
			if($format==FORMAT_NUMBER || IsNumberType($pSet->getFieldType("DEL_PREVIOUS")))
				$class = ' rnr-field-number';
			$row["DEL_PREVIOUS_class"] = $class;
	//	DEL_LAST_INDEX - 
			$viewContainer->recId = $recordsCounter;
	...
	//	DEL_TYPE - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("DEL_TYPE", $data, $keylink);
			$row["DEL_TYPE_value"] = $value;
			$format = $pSet->getViewFormat("DEL_TYPE");
			$class = "rnr-field-text";
			if($format==FORMAT_FILE) 
				$class = ' rnr-field-file'; 
			if($format==FORMAT_AUDIO)
			...
			if($format==FORMAT_CHECKBOX)
				$class = ' rnr-field-checkbox';
			if($format==FORMAT_NUMBER || IsNumberType($pSet->getFieldType("DEL_TYPE")))
				$class = ' rnr-field-number';
			$row["DEL_TYPE_class"] = $class;
	//	DEL_THREAD - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("DEL_THREAD", $data, $keylink);
			$row["DEL_THREAD_value"] = $value;
			$format = $pSet->getViewFormat("DEL_THREAD");
			$class = "rnr-field-text";
			if($format==FORMAT_FILE) 
				$class = ' rnr-field-file'; 
			if($format==FORMAT_AUDIO)
			...
			if($format==FORMAT_CHECKBOX)
				$class = ' rnr-field-checkbox';
			if($format==FORMAT_NUMBER || IsNumberType($pSet->getFieldType("DEL_THREAD")))
				$class = ' rnr-field-number';
			$row["DEL_THREAD_class"] = $class;
	//	DEL_THREAD_STATUS - 
			$viewContainer->recId = $recordsCounter;
	...
	//	DEL_DATA - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("DEL_DATA", $data, $keylink);
			$row["DEL_DATA_value"] = $value;
			$format = $pSet->getViewFormat("DEL_DATA");
			$class = "rnr-field-text";
			if($format==FORMAT_FILE) 
				$class = ' rnr-field-file'; 
			if($format==FORMAT_AUDIO)
			...
			if($format==FORMAT_CHECKBOX)
				$class = ' rnr-field-checkbox';
			if($format==FORMAT_NUMBER || IsNumberType($pSet->getFieldType("DEL_DATA")))
				$class = ' rnr-field-number';
			$row["DEL_DATA_class"] = $class;
	...
	//	DELEGATION_ID - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("DELEGATION_ID", $data, $keylink);
			$row["DELEGATION_ID_value"] = $value;
			$format = $pSet->getViewFormat("DELEGATION_ID");
			$class = "rnr-field-text";
			if($format==FORMAT_FILE) 
				$class = ' rnr-field-file'; 
			if($format==FORMAT_AUDIO)
			...
			if($format==FORMAT_CHECKBOX)
				$class = ' rnr-field-checkbox';
			if($format==FORMAT_NUMBER || IsNumberType($pSet->getFieldType("DELEGATION_ID")))
				$class = ' rnr-field-number';
			$row["DELEGATION_ID_class"] = $class;
	//	APP_NUMBER - 
			$viewContainer->recId = $recordsCounter;
	...
	//	USR_ID - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("USR_ID", $data, $keylink);
			$row["USR_ID_value"] = $value;
			$format = $pSet->getViewFormat("USR_ID");
			$class = "rnr-field-text";
			if($format==FORMAT_FILE) 
				$class = ' rnr-field-file'; 
			if($format==FORMAT_AUDIO)
			...
			if($format==FORMAT_CHECKBOX)
				$class = ' rnr-field-checkbox';
			if($format==FORMAT_NUMBER || IsNumberType($pSet->getFieldType("USR_ID")))
				$class = ' rnr-field-number';
			$row["USR_ID_class"] = $class;
	//	PRO_ID - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template(GetTemplateName("APP_DELEGATION", "detailspreview"));
