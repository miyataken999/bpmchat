...
require_once("include/retblheating_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "retblheating_edit";
...
$page_layouts["retblheating_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "retblheating_list";
...
$page_layouts["retblheating_list"] = $layout;
...
$keys = array();
$keys["HeatingID"] = postvalue("editid1");
