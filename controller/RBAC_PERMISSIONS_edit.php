...
require_once("include/RBAC_PERMISSIONS_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "RBAC_PERMISSIONS_edit";
...
$page_layouts["RBAC_PERMISSIONS_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "RBAC_PERMISSIONS_list";
...
$page_layouts["RBAC_PERMISSIONS_list"] = $layout;
...
$keys = array();
$keys["PER_UID"] = postvalue("editid1");
