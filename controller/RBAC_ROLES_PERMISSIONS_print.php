...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "RBAC_ROLES_PERMISSIONS_print";
...
$page_layouts["RBAC_ROLES_PERMISSIONS_print"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "RBAC_ROLES_masterprint";
...
$page_layouts["RBAC_ROLES_masterprint"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "RBAC_PERMISSIONS_masterprint";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
$layout->container_properties["column"] = array(  );
$layout->containers["column"][] = array("name"=>"masterprintheader",
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["RBAC_PERMISSIONS_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "RBAC_ROLES_PERMISSIONS" );
