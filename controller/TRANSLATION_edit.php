...
require_once("include/TRANSLATION_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "TRANSLATION_edit";
...
$page_layouts["TRANSLATION_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "TRANSLATION_list";
...
$page_layouts["TRANSLATION_list"] = $layout;
...
$keys = array();
$keys["TRN_CATEGORY"] = postvalue("editid1");
$keys["TRN_ID"] = postvalue("editid2");
$keys["TRN_LANG"] = postvalue("editid3");
