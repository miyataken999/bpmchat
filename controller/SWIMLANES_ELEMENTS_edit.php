...
require_once("include/SWIMLANES_ELEMENTS_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "SWIMLANES_ELEMENTS_edit";
...
$page_layouts["SWIMLANES_ELEMENTS_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "SWIMLANES_ELEMENTS_list";
...
$page_layouts["SWIMLANES_ELEMENTS_list"] = $layout;
...
$keys = array();
$keys["SWI_UID"] = postvalue("editid1");
