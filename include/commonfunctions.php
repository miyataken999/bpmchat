...
function checkTableName($shortTName, $type=false)
{
	...
	if ("ABE_CONFIGURATION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ABE_REQUESTS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ABE_RESPONSES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ADDITIONAL_TABLES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ADDONS_MANAGER" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ADDONS_STORE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APPLICATION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_ASSIGN_SELF_SERVICE_VALUE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_CACHE_VIEW" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_DELAY" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_DELEGATION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("USERS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("TRANSLATION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("admin_rights" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("BPMN_PROJECT" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMN_PROCESS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("CONTENT" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PROCESS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PROCESS_CATEGORY" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PROCESS_FILES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PROCESS_OWNER" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PROCESS_USER" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PROCESS_VARIABLES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("TRIGGERS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("USERS_PROPERTIES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("USR_REPORTING" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("WEB_ENTRY" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("TASK" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("TASK_USER" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMN_PARTICIPANT" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMN_LANESET" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMN_LANE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMN_GATEWAY" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMN_FLOW" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMN_EXTENSION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMN_EVENT" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMN_DOCUMENTATION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMN_DIAGRAM" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMN_DATA" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMN_BOUND" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMN_ACTIVITY" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMN_ARTIFACT" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("DYNAFORM" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APPLICATION1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("APP_DOCUMENT" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_EVENT" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_FOLDER" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_HISTORY" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_MESSAGE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_NOTES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_OWNER" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_SEQUENCE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_SOLR_QUEUE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_THREAD" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_TIMEOUT_ACTION_EXECUTED" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ISO_COUNTRY" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ISO_LOCATION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ISO_SUBDIVISION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("LANGUAGE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("LEXICO" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("STEP" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("STEP_TRIGGER" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("SUB_APPLICATION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ROUTE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("processmaker_audit" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("processmaker_locking" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("processmaker_uggroups" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("processmaker_ugmembers" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("processmaker_ugrights" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_MENU" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_MENU1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("CONTENT1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("CONTENT11" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("CONTENT2" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("CONTENT3" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("PRO_REPORTING" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("LOGIN_LOG" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("LOG_CASES_SCHEDULER" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("LIST_UNASSIGNED_GROUP" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("LIST_UNASSIGNED" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("LIST_PAUSED" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("LIST_PARTICIPATED_LAST" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("LIST_PARTICIPATED_HISTORY" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("LIST_MY_INBOX" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("LIST_INBOX" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("LIST_COMPLETED" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("LIST_CANCELED" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("LICENSE_MANAGER" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("CONTENT4" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("CONTENT41" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("CONTENT411" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("RBAC_AUTHENTICATION_SOURCE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("RBAC_PERMISSIONS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("RBAC_ROLES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("RBAC_ROLES_PERMISSIONS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("RBAC_SYSTEMS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("RBAC_USERS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("RBAC_USERS_ROLES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("DB_SOURCE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("DEPARTMENT" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GROUPWF" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GROUP_USER" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("MESSAGE_APPLICATION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("MESSAGE_EVENT_DEFINITION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("MESSAGE_EVENT_RELATION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("MESSAGE_TYPE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("SCRIPT_TASK" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("SEQUENCES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("SESSION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("STAGE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("STEP_SUPERVISOR" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("SUB_PROCESS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("SWIMLANES_ELEMENTS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("FIELDS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("FIELD_CONDITION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("CATALOG" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("CASE_TRACKER_OBJECT" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("CASE_TRACKER" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("CASE_SCHEDULER" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("CASE_CONSOLIDATED" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("REPORT_TABLE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("REPORT_VAR" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("WEB_ENTRY_EVENT" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("CONFIGURATION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("DIM_TIME_COMPLETE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("DIM_TIME_DELEGATE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ELEMENT_TASK_RELATION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("TIMER_EVENT" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_COMMAND" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_CACHE_VIEW_INDEX" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	...
	if ("Dashboard" == $shortTName && ($type===false || ($type!==false && $type == 4)))
		return true;
	if ("PMT_LINE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_FIELD" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_COMMAND_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("APP_CACHE_VIEW_DRAFT" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("APP_CACHE_VIEW_PARTICIPATE" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("APP_CACHE_VIEW_PAUSE" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("INPUT_DOCUMENT" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("EMAIL_EVENT" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("DASHLET_INSTANCE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("DASHBOARD_INDICATOR" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("DASHLET" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("DASHBOARD_DAS_IND" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("DASHBOARD1" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("general_log" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("COLUMNS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("TRIGGERS1" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("TABLES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("SCHEMATA" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_ECCUBE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_ECCUBEBLOG" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("modx_site_content" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("modx_site_htmlsnippets" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("modx_site_snippets" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("modx_site_templates" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("modx_site_plugins" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("modx_categories" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APPLICATION_Chart" == $shortTName && ($type===false || ($type!==false && $type == 3)))
		return true;
	if ("APPLICATION_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("modx_site_content_child" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("modx_site_content_dash" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("site_content_dashboard" == $shortTName && ($type===false || ($type!==false && $type == 4)))
		return true;
	if ("Dashboard2" == $shortTName && ($type===false || ($type!==false && $type == 4)))
		return true;
	if ("BPMBOXEoc2" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("items" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ppmain" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pppaypal_info" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ppadmin_main" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("ppsubcategory" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ppusers" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ppcategory" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ppcategory1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("API" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("CALENDAR_ASSIGNMENTS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("CALENDAR_BUSINESS_HOURS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("CALENDAR_DEFINITION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("CALENDAR_HOLIDAYS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GATEWAY" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GMAIL_RELABELING" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("HOLIDAY" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("MESSAGE_TYPE_VARIABLE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("NOTIFICATION_DEVICE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("NOTIFICATION_QUEUE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("OAUTH_ACCESS_TOKENS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("OAUTH_AUTHORIZATION_CODES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("OAUTH_CLIENTS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("OAUTH_REFRESH_TOKENS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("OAUTH_SCOPES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("OBJECT_PERMISSION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("OUTPUT_DOCUMENT" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMOAUTH_USER_ACCESS_TOKENS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("SESSION_STORAGE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("SHADOW_TABLE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("APP_ASSIGN_SELF_SERVICE_VALUE_GROUP" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("modxdf_site_templates" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("modxdf_site_snippets" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("modxdf_site_plugins" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("modxdf_site_content" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("modxdf_site_htmlsnippets" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("modxdf_site_tmplvars" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("WEBSOCKET" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_TEST_BUSINESS_3" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_SITE_REGISTRATION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMCHAT" == $shortTName && ($type===false || ($type!==false && $type == 4)))
		return true;
	if ("HITWORD" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PLUGINS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("TABLESPACES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("TABLE_CONSTRAINTS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_SITE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("wpfg_commentmeta" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("wpfg_comments" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("wpfg_links" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("wpfg_options" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("wpfg_postmeta" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("wpfg_posts" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("wpfg_term_relationships" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("wpfg_term_taxonomy" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("wpfg_termmeta" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("wpfg_terms" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("wpfg_usermeta" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("wpfg_users" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_ANNUAL_REVENUE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_TEST_BUSINESS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_SAGAWA" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_RESIDENTS_BASIC_ATTRIBUTES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_QUOTE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_SUBCONTRACTORS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_MITUMORI1" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("BPMBOXTRANS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Dashboard3" == $shortTName && ($type===false || ($type!==false && $type == 4)))
		return true;
	if ("APPLICATION_Report1" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("ROUTINES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_INVOICE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_INVOICE_ITEMS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_TEST_SCREEN" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_SPREADMAIN" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_SPREADSUB" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_PROGRAM_LIST" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_PMSEIKYUUSHO" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_MST_BRMS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PMT_QUOTE_DETAILS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
...
{
	$arr = array();
	$strPerm = GetUserPermissions("ABE_CONFIGURATION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ABE_CONFIGURATION";
	}
	$strPerm = GetUserPermissions("ABE_REQUESTS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ABE_REQUESTS";
	}
	$strPerm = GetUserPermissions("ABE_RESPONSES");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ABE_RESPONSES";
	}
	$strPerm = GetUserPermissions("ADDITIONAL_TABLES");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ADDITIONAL_TABLES";
	}
	$strPerm = GetUserPermissions("ADDONS_MANAGER");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ADDONS_MANAGER";
	}
	$strPerm = GetUserPermissions("ADDONS_STORE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ADDONS_STORE";
	}
	...
	$strPerm = GetUserPermissions("APP_ASSIGN_SELF_SERVICE_VALUE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_ASSIGN_SELF_SERVICE_VALUE";
	}
	$strPerm = GetUserPermissions("APP_CACHE_VIEW");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_CACHE_VIEW";
	}
	$strPerm = GetUserPermissions("APP_DELAY");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_DELAY";
	}
	$strPerm = GetUserPermissions("APP_DELEGATION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_DELEGATION";
	}
	...
	$strPerm = GetUserPermissions("TRANSLATION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="TRANSLATION";
	}
	...
	$strPerm = GetUserPermissions("BPMN_PROJECT");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMN_PROJECT";
	}
	$strPerm = GetUserPermissions("BPMN_PROCESS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMN_PROCESS";
	}
	$strPerm = GetUserPermissions("CONTENT");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CONTENT";
	}
	...
	$strPerm = GetUserPermissions("PROCESS_CATEGORY");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PROCESS_CATEGORY";
	}
	$strPerm = GetUserPermissions("PROCESS_FILES");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PROCESS_FILES";
	}
	$strPerm = GetUserPermissions("PROCESS_OWNER");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PROCESS_OWNER";
	}
	$strPerm = GetUserPermissions("PROCESS_USER");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PROCESS_USER";
	}
	$strPerm = GetUserPermissions("PROCESS_VARIABLES");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PROCESS_VARIABLES";
	}
	$strPerm = GetUserPermissions("TRIGGERS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="TRIGGERS";
	}
	$strPerm = GetUserPermissions("USERS_PROPERTIES");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="USERS_PROPERTIES";
	}
	$strPerm = GetUserPermissions("USR_REPORTING");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="USR_REPORTING";
	}
	$strPerm = GetUserPermissions("WEB_ENTRY");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="WEB_ENTRY";
	}
	$strPerm = GetUserPermissions("TASK");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="TASK";
	}
	$strPerm = GetUserPermissions("TASK_USER");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="TASK_USER";
	}
	$strPerm = GetUserPermissions("BPMN_PARTICIPANT");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMN_PARTICIPANT";
	}
	$strPerm = GetUserPermissions("BPMN_LANESET");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMN_LANESET";
	}
	$strPerm = GetUserPermissions("BPMN_LANE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMN_LANE";
	}
	$strPerm = GetUserPermissions("BPMN_GATEWAY");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMN_GATEWAY";
	}
	$strPerm = GetUserPermissions("BPMN_FLOW");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMN_FLOW";
	}
	$strPerm = GetUserPermissions("BPMN_EXTENSION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMN_EXTENSION";
	}
	$strPerm = GetUserPermissions("BPMN_EVENT");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMN_EVENT";
	}
	$strPerm = GetUserPermissions("BPMN_DOCUMENTATION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMN_DOCUMENTATION";
	}
	$strPerm = GetUserPermissions("BPMN_DIAGRAM");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMN_DIAGRAM";
	}
	$strPerm = GetUserPermissions("BPMN_DATA");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMN_DATA";
	}
	$strPerm = GetUserPermissions("BPMN_BOUND");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMN_BOUND";
	}
	$strPerm = GetUserPermissions("BPMN_ACTIVITY");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMN_ACTIVITY";
	}
	$strPerm = GetUserPermissions("BPMN_ARTIFACT");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMN_ARTIFACT";
	}
	$strPerm = GetUserPermissions("DYNAFORM");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="DYNAFORM";
	}
	$strPerm = GetUserPermissions("APPLICATION1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APPLICATION1";
	}
	$strPerm = GetUserPermissions("APP_DOCUMENT");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_DOCUMENT";
	}
	$strPerm = GetUserPermissions("APP_EVENT");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_EVENT";
	}
	$strPerm = GetUserPermissions("APP_FOLDER");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_FOLDER";
	}
	$strPerm = GetUserPermissions("APP_HISTORY");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_HISTORY";
	}
	$strPerm = GetUserPermissions("APP_MESSAGE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_MESSAGE";
	}
	$strPerm = GetUserPermissions("APP_NOTES");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_NOTES";
	}
	$strPerm = GetUserPermissions("APP_OWNER");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_OWNER";
	}
	$strPerm = GetUserPermissions("APP_SEQUENCE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_SEQUENCE";
	}
	$strPerm = GetUserPermissions("APP_SOLR_QUEUE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_SOLR_QUEUE";
	}
	$strPerm = GetUserPermissions("APP_THREAD");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_THREAD";
	}
	$strPerm = GetUserPermissions("APP_TIMEOUT_ACTION_EXECUTED");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_TIMEOUT_ACTION_EXECUTED";
	}
	$strPerm = GetUserPermissions("ISO_COUNTRY");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ISO_COUNTRY";
	}
	$strPerm = GetUserPermissions("ISO_LOCATION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ISO_LOCATION";
	}
	$strPerm = GetUserPermissions("ISO_SUBDIVISION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ISO_SUBDIVISION";
	}
	...
	$strPerm = GetUserPermissions("LEXICO");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LEXICO";
	}
	$strPerm = GetUserPermissions("STEP");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="STEP";
	}
	$strPerm = GetUserPermissions("STEP_TRIGGER");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="STEP_TRIGGER";
	}
	$strPerm = GetUserPermissions("SUB_APPLICATION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="SUB_APPLICATION";
	}
	$strPerm = GetUserPermissions("ROUTE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ROUTE";
	}
	$strPerm = GetUserPermissions("processmaker_audit");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="processmaker_audit";
	}
	$strPerm = GetUserPermissions("processmaker_locking");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="processmaker_locking";
	}
	$strPerm = GetUserPermissions("processmaker_uggroups");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="processmaker_uggroups";
	}
	$strPerm = GetUserPermissions("processmaker_ugmembers");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="processmaker_ugmembers";
	}
	$strPerm = GetUserPermissions("processmaker_ugrights");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="processmaker_ugrights";
	}
	$strPerm = GetUserPermissions("PMT_MENU");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_MENU";
	}
	$strPerm = GetUserPermissions("PMT_MENU1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_MENU1";
	}
	$strPerm = GetUserPermissions("CONTENT1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CONTENT1";
	}
	$strPerm = GetUserPermissions("CONTENT11");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CONTENT11";
	}
	$strPerm = GetUserPermissions("CONTENT2");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CONTENT2";
	}
	$strPerm = GetUserPermissions("CONTENT3");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CONTENT3";
	}
	$strPerm = GetUserPermissions("PRO_REPORTING");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PRO_REPORTING";
	}
	$strPerm = GetUserPermissions("LOGIN_LOG");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LOGIN_LOG";
	}
	$strPerm = GetUserPermissions("LOG_CASES_SCHEDULER");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LOG_CASES_SCHEDULER";
	}
	$strPerm = GetUserPermissions("LIST_UNASSIGNED_GROUP");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LIST_UNASSIGNED_GROUP";
	}
	$strPerm = GetUserPermissions("LIST_UNASSIGNED");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LIST_UNASSIGNED";
	}
	$strPerm = GetUserPermissions("LIST_PAUSED");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LIST_PAUSED";
	}
	$strPerm = GetUserPermissions("LIST_PARTICIPATED_LAST");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LIST_PARTICIPATED_LAST";
	}
	$strPerm = GetUserPermissions("LIST_PARTICIPATED_HISTORY");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LIST_PARTICIPATED_HISTORY";
	}
	$strPerm = GetUserPermissions("LIST_MY_INBOX");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LIST_MY_INBOX";
	}
	$strPerm = GetUserPermissions("LIST_INBOX");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LIST_INBOX";
	}
	$strPerm = GetUserPermissions("LIST_COMPLETED");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LIST_COMPLETED";
	}
	$strPerm = GetUserPermissions("LIST_CANCELED");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LIST_CANCELED";
	}
	$strPerm = GetUserPermissions("LICENSE_MANAGER");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="LICENSE_MANAGER";
	}
	$strPerm = GetUserPermissions("CONTENT4");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CONTENT4";
	}
	$strPerm = GetUserPermissions("CONTENT41");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CONTENT41";
	}
	$strPerm = GetUserPermissions("CONTENT411");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CONTENT411";
	}
	$strPerm = GetUserPermissions("RBAC_AUTHENTICATION_SOURCE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="RBAC_AUTHENTICATION_SOURCE";
	}
	$strPerm = GetUserPermissions("RBAC_PERMISSIONS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="RBAC_PERMISSIONS";
	}
	$strPerm = GetUserPermissions("RBAC_ROLES");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="RBAC_ROLES";
	}
	$strPerm = GetUserPermissions("RBAC_ROLES_PERMISSIONS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="RBAC_ROLES_PERMISSIONS";
	}
	$strPerm = GetUserPermissions("RBAC_SYSTEMS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="RBAC_SYSTEMS";
	}
	$strPerm = GetUserPermissions("RBAC_USERS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="RBAC_USERS";
	}
	$strPerm = GetUserPermissions("RBAC_USERS_ROLES");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="RBAC_USERS_ROLES";
	}
	$strPerm = GetUserPermissions("DB_SOURCE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="DB_SOURCE";
	}
	...
	$strPerm = GetUserPermissions("GROUPWF");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="GROUPWF";
	}
	$strPerm = GetUserPermissions("GROUP_USER");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="GROUP_USER";
	}
	$strPerm = GetUserPermissions("MESSAGE_APPLICATION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="MESSAGE_APPLICATION";
	}
	$strPerm = GetUserPermissions("MESSAGE_EVENT_DEFINITION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="MESSAGE_EVENT_DEFINITION";
	}
	$strPerm = GetUserPermissions("MESSAGE_EVENT_RELATION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="MESSAGE_EVENT_RELATION";
	}
	$strPerm = GetUserPermissions("MESSAGE_TYPE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="MESSAGE_TYPE";
	}
	$strPerm = GetUserPermissions("SCRIPT_TASK");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="SCRIPT_TASK";
	}
	$strPerm = GetUserPermissions("SEQUENCES");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="SEQUENCES";
	}
	$strPerm = GetUserPermissions("SESSION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="SESSION";
	}
	...
	$strPerm = GetUserPermissions("STEP_SUPERVISOR");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="STEP_SUPERVISOR";
	}
	$strPerm = GetUserPermissions("SUB_PROCESS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="SUB_PROCESS";
	}
	$strPerm = GetUserPermissions("SWIMLANES_ELEMENTS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="SWIMLANES_ELEMENTS";
	}
	$strPerm = GetUserPermissions("FIELDS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="FIELDS";
	}
	$strPerm = GetUserPermissions("FIELD_CONDITION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="FIELD_CONDITION";
	}
	$strPerm = GetUserPermissions("CATALOG");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CATALOG";
	}
	$strPerm = GetUserPermissions("CASE_TRACKER_OBJECT");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CASE_TRACKER_OBJECT";
	}
	$strPerm = GetUserPermissions("CASE_TRACKER");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CASE_TRACKER";
	}
	$strPerm = GetUserPermissions("CASE_SCHEDULER");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CASE_SCHEDULER";
	}
	$strPerm = GetUserPermissions("CASE_CONSOLIDATED");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CASE_CONSOLIDATED";
	}
	$strPerm = GetUserPermissions("REPORT_TABLE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="REPORT_TABLE";
	}
	$strPerm = GetUserPermissions("REPORT_VAR");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="REPORT_VAR";
	}
	$strPerm = GetUserPermissions("WEB_ENTRY_EVENT");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="WEB_ENTRY_EVENT";
	}
	$strPerm = GetUserPermissions("CONFIGURATION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CONFIGURATION";
	}
	$strPerm = GetUserPermissions("DIM_TIME_COMPLETE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="DIM_TIME_COMPLETE";
	}
	$strPerm = GetUserPermissions("DIM_TIME_DELEGATE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="DIM_TIME_DELEGATE";
	}
	$strPerm = GetUserPermissions("ELEMENT_TASK_RELATION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ELEMENT_TASK_RELATION";
	}
	$strPerm = GetUserPermissions("TIMER_EVENT");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="TIMER_EVENT";
	}
	$strPerm = GetUserPermissions("PMT_COMMAND");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_COMMAND";
	}
	$strPerm = GetUserPermissions("APP_CACHE_VIEW_INDEX");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_CACHE_VIEW_INDEX";
	}
	...
	$strPerm = GetUserPermissions("PMT_LINE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_LINE";
	}
	$strPerm = GetUserPermissions("PMT_FIELD");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_FIELD";
	}
	$strPerm = GetUserPermissions("PMT_COMMAND Report");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_COMMAND Report";
	}
	$strPerm = GetUserPermissions("APP_CACHE_VIEW_DRAFT");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_CACHE_VIEW_DRAFT";
	}
	$strPerm = GetUserPermissions("APP_CACHE_VIEW_PARTICIPATE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_CACHE_VIEW_PARTICIPATE";
	}
	$strPerm = GetUserPermissions("APP_CACHE_VIEW_PAUSE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_CACHE_VIEW_PAUSE";
	}
	$strPerm = GetUserPermissions("INPUT_DOCUMENT");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="INPUT_DOCUMENT";
	}
	$strPerm = GetUserPermissions("EMAIL_EVENT");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="EMAIL_EVENT";
	}
	$strPerm = GetUserPermissions("DASHLET_INSTANCE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="DASHLET_INSTANCE";
	}
	$strPerm = GetUserPermissions("DASHBOARD_INDICATOR");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="DASHBOARD_INDICATOR";
	}
	$strPerm = GetUserPermissions("DASHLET");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="DASHLET";
	}
	$strPerm = GetUserPermissions("DASHBOARD_DAS_IND");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="DASHBOARD_DAS_IND";
	}
	$strPerm = GetUserPermissions("DASHBOARD1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="DASHBOARD1";
	}
	$strPerm = GetUserPermissions("general_log");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="general_log";
	}
	$strPerm = GetUserPermissions("COLUMNS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="COLUMNS";
	}
	$strPerm = GetUserPermissions("TRIGGERS1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="TRIGGERS1";
	}
	$strPerm = GetUserPermissions("TABLES");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="TABLES";
	}
	$strPerm = GetUserPermissions("SCHEMATA");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="SCHEMATA";
	}
	$strPerm = GetUserPermissions("PMT_ECCUBE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_ECCUBE";
	}
	$strPerm = GetUserPermissions("PMT_ECCUBEBLOG");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_ECCUBEBLOG";
	}
	$strPerm = GetUserPermissions("modx_site_content");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="modx_site_content";
	}
	$strPerm = GetUserPermissions("modx_site_htmlsnippets");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="modx_site_htmlsnippets";
	}
	$strPerm = GetUserPermissions("modx_site_snippets");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="modx_site_snippets";
	}
	$strPerm = GetUserPermissions("modx_site_templates");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="modx_site_templates";
	}
	$strPerm = GetUserPermissions("modx_site_plugins");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="modx_site_plugins";
	}
	$strPerm = GetUserPermissions("modx_categories");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="modx_categories";
	}
	$strPerm = GetUserPermissions("APPLICATION Chart");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APPLICATION Chart";
	}
	$strPerm = GetUserPermissions("APPLICATION Report");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APPLICATION Report";
	}
	$strPerm = GetUserPermissions("modx_site_content_child");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="modx_site_content_child";
	}
	$strPerm = GetUserPermissions("modx_site_content_dash");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="modx_site_content_dash";
	}
	$strPerm = GetUserPermissions("site_content_dashboard");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="site_content_dashboard";
	}
	$strPerm = GetUserPermissions("Dashboard2");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Dashboard2";
	}
	$strPerm = GetUserPermissions("BPMBOXEoc2");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMBOXEoc2";
	}
	$strPerm = GetUserPermissions("items");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="items";
	}
	$strPerm = GetUserPermissions("ppmain");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ppmain";
	}
	$strPerm = GetUserPermissions("pppaypal_info");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="pppaypal_info";
	}
	$strPerm = GetUserPermissions("ppadmin main");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ppadmin main";
	}
	$strPerm = GetUserPermissions("ppsubcategory");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ppsubcategory";
	}
	$strPerm = GetUserPermissions("ppusers");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ppusers";
	}
	$strPerm = GetUserPermissions("ppcategory");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ppcategory";
	}
	$strPerm = GetUserPermissions("ppcategory1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ppcategory1";
	}
	$strPerm = GetUserPermissions("API");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="API";
	}
	$strPerm = GetUserPermissions("CALENDAR_ASSIGNMENTS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CALENDAR_ASSIGNMENTS";
	}
	$strPerm = GetUserPermissions("CALENDAR_BUSINESS_HOURS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CALENDAR_BUSINESS_HOURS";
	}
	$strPerm = GetUserPermissions("CALENDAR_DEFINITION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CALENDAR_DEFINITION";
	}
	$strPerm = GetUserPermissions("CALENDAR_HOLIDAYS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="CALENDAR_HOLIDAYS";
	}
	$strPerm = GetUserPermissions("GATEWAY");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="GATEWAY";
	}
	$strPerm = GetUserPermissions("GMAIL_RELABELING");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="GMAIL_RELABELING";
	}
	$strPerm = GetUserPermissions("HOLIDAY");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="HOLIDAY";
	}
	$strPerm = GetUserPermissions("MESSAGE_TYPE_VARIABLE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="MESSAGE_TYPE_VARIABLE";
	}
	$strPerm = GetUserPermissions("NOTIFICATION_DEVICE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="NOTIFICATION_DEVICE";
	}
	$strPerm = GetUserPermissions("NOTIFICATION_QUEUE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="NOTIFICATION_QUEUE";
	}
	$strPerm = GetUserPermissions("OAUTH_ACCESS_TOKENS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="OAUTH_ACCESS_TOKENS";
	}
	$strPerm = GetUserPermissions("OAUTH_AUTHORIZATION_CODES");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="OAUTH_AUTHORIZATION_CODES";
	}
	$strPerm = GetUserPermissions("OAUTH_CLIENTS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="OAUTH_CLIENTS";
	}
	$strPerm = GetUserPermissions("OAUTH_REFRESH_TOKENS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="OAUTH_REFRESH_TOKENS";
	}
	$strPerm = GetUserPermissions("OAUTH_SCOPES");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="OAUTH_SCOPES";
	}
	$strPerm = GetUserPermissions("OBJECT_PERMISSION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="OBJECT_PERMISSION";
	}
	$strPerm = GetUserPermissions("OUTPUT_DOCUMENT");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="OUTPUT_DOCUMENT";
	}
	$strPerm = GetUserPermissions("PMOAUTH_USER_ACCESS_TOKENS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMOAUTH_USER_ACCESS_TOKENS";
	}
	$strPerm = GetUserPermissions("SESSION_STORAGE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="SESSION_STORAGE";
	}
	$strPerm = GetUserPermissions("SHADOW_TABLE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="SHADOW_TABLE";
	}
	$strPerm = GetUserPermissions("APP_ASSIGN_SELF_SERVICE_VALUE_GROUP");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APP_ASSIGN_SELF_SERVICE_VALUE_GROUP";
	}
	$strPerm = GetUserPermissions("modxdf_site_templates");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="modxdf_site_templates";
	}
	$strPerm = GetUserPermissions("modxdf_site_snippets");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="modxdf_site_snippets";
	}
	$strPerm = GetUserPermissions("modxdf_site_plugins");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="modxdf_site_plugins";
	}
	$strPerm = GetUserPermissions("modxdf_site_content");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="modxdf_site_content";
	}
	$strPerm = GetUserPermissions("modxdf_site_htmlsnippets");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="modxdf_site_htmlsnippets";
	}
	$strPerm = GetUserPermissions("modxdf_site_tmplvars");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="modxdf_site_tmplvars";
	}
	$strPerm = GetUserPermissions("WEBSOCKET");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="WEBSOCKET";
	}
	$strPerm = GetUserPermissions("PMT_TEST_BUSINESS_3");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_TEST_BUSINESS_3";
	}
	$strPerm = GetUserPermissions("PMT_SITE_REGISTRATION");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_SITE_REGISTRATION";
	}
	$strPerm = GetUserPermissions("BPMCHAT");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMCHAT";
	}
	$strPerm = GetUserPermissions("HITWORD");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="HITWORD";
	}
	$strPerm = GetUserPermissions("PLUGINS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PLUGINS";
	}
	$strPerm = GetUserPermissions("TABLESPACES");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="TABLESPACES";
	}
	$strPerm = GetUserPermissions("TABLE_CONSTRAINTS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="TABLE_CONSTRAINTS";
	}
	$strPerm = GetUserPermissions("PMT_SITE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_SITE";
	}
	$strPerm = GetUserPermissions("wpfg_commentmeta");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="wpfg_commentmeta";
	}
	$strPerm = GetUserPermissions("wpfg_comments");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="wpfg_comments";
	}
	$strPerm = GetUserPermissions("wpfg_links");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="wpfg_links";
	}
	$strPerm = GetUserPermissions("wpfg_options");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="wpfg_options";
	}
	$strPerm = GetUserPermissions("wpfg_postmeta");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="wpfg_postmeta";
	}
	$strPerm = GetUserPermissions("wpfg_posts");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="wpfg_posts";
	}
	$strPerm = GetUserPermissions("wpfg_term_relationships");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="wpfg_term_relationships";
	}
	$strPerm = GetUserPermissions("wpfg_term_taxonomy");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="wpfg_term_taxonomy";
	}
	$strPerm = GetUserPermissions("wpfg_termmeta");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="wpfg_termmeta";
	}
	$strPerm = GetUserPermissions("wpfg_terms");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="wpfg_terms";
	}
	$strPerm = GetUserPermissions("wpfg_usermeta");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="wpfg_usermeta";
	}
	$strPerm = GetUserPermissions("wpfg_users");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="wpfg_users";
	}
	$strPerm = GetUserPermissions("PMT_ANNUAL_REVENUE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_ANNUAL_REVENUE";
	}
	$strPerm = GetUserPermissions("PMT_TEST_BUSINESS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_TEST_BUSINESS";
	}
	$strPerm = GetUserPermissions("PMT_SAGAWA");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_SAGAWA";
	}
	$strPerm = GetUserPermissions("PMT_RESIDENTS_BASIC_ATTRIBUTES");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_RESIDENTS_BASIC_ATTRIBUTES";
	}
	$strPerm = GetUserPermissions("PMT_QUOTE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_QUOTE";
	}
	$strPerm = GetUserPermissions("PMT_SUBCONTRACTORS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_SUBCONTRACTORS";
	}
	$strPerm = GetUserPermissions("PMT_MITUMORI1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_MITUMORI1";
	}
	$strPerm = GetUserPermissions("BPMBOXTRANS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="BPMBOXTRANS";
	}
	$strPerm = GetUserPermissions("Dashboard3");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Dashboard3";
	}
	$strPerm = GetUserPermissions("APPLICATION Report1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="APPLICATION Report1";
	}
	$strPerm = GetUserPermissions("ROUTINES");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ROUTINES";
	}
	$strPerm = GetUserPermissions("PMT_INVOICE");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_INVOICE";
	}
	$strPerm = GetUserPermissions("PMT_INVOICE_ITEMS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_INVOICE_ITEMS";
	}
	$strPerm = GetUserPermissions("PMT_TEST_SCREEN");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_TEST_SCREEN";
	}
	$strPerm = GetUserPermissions("PMT_SPREADMAIN");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_SPREADMAIN";
	}
	$strPerm = GetUserPermissions("PMT_SPREADSUB");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_SPREADSUB";
	}
	$strPerm = GetUserPermissions("PMT_PROGRAM_LIST");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_PROGRAM_LIST";
	}
	$strPerm = GetUserPermissions("PMT_PMSEIKYUUSHO");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_PMSEIKYUUSHO";
	}
	$strPerm = GetUserPermissions("PMT_MST_BRMS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_MST_BRMS";
	}
	$strPerm = GetUserPermissions("PMT_QUOTE_DETAILS");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="PMT_QUOTE_DETAILS";
	}
	return $arr;
}
...
{
	if($shorttable=="APPLICATION_Chart")
		return "Bubble";
	return "";
}
...
function ReadUserPermissions($userID = "")
{
	...
	if($userID != "Guest")
	{
		...
		$sql = "select ".$gConn->addFieldWrappers( "GroupID" )
			...
			." from ". $gConn->addTableWrappers( "processmaker_ugmembers" )
	...
	$sql = "select ". $gConn->addFieldWrappers( "TableName" )
		...
		." from ". $gConn->addTableWrappers( "processmaker_ugrights" )
...
{
	global $globalEvents;
	$_SESSION["GroupID"] = $data["USR_UID"];


		$_SESSION["OwnerID"] = $data["DEP_UID"];
	$_SESSION["_ABE_CONFIGURATION_OwnerID"] = $data["DEP_UID"];
		$_SESSION["_DEPARTMENT_OwnerID"] = $data["DEP_UID"];
		$_SESSION["_APP_CACHE_VIEW_INDEX_OwnerID"] = $data["USR_UID"];
		$_SESSION["_APP_CACHE_VIEW_DRAFT_OwnerID"] = $data["USR_UID"];
		$_SESSION["_ppmain_OwnerID"] = $data["username"];
		$_SESSION["_pppaypal_info_OwnerID"] = $data["username"];
		$_SESSION["_ppadmin main_OwnerID"] = $data["username"];
		$_SESSION["_ppsubcategory_OwnerID"] = $data["username"];
		$_SESSION["_ppusers_OwnerID"] = $data["username"];
		$_SESSION["_ppcategory_OwnerID"] = $data["username"];
		$_SESSION["_ppcategory1_OwnerID"] = $data["username"];
		$_SESSION["_APP_ASSIGN_SELF_SERVICE_VALUE_GROUP_OwnerID"] = $data["DEP_UID"];
		$_SESSION["_PMT_MITUMORI1_OwnerID"] = $data["USR_ID"];
