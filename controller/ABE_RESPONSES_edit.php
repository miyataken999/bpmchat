...
require_once("include/ABE_RESPONSES_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "ABE_RESPONSES_edit";
...
$page_layouts["ABE_RESPONSES_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "ABE_RESPONSES_list";
...
$page_layouts["ABE_RESPONSES_list"] = $layout;
...
$keys = array();
$keys["ABE_RES_UID"] = postvalue("editid1");
