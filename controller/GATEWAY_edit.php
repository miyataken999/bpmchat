...
require_once("include/GATEWAY_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "GATEWAY_edit";
...
$page_layouts["GATEWAY_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "GATEWAY_list";
...
$page_layouts["GATEWAY_list"] = $layout;
...
$keys = array();
$keys["GAT_UID"] = postvalue("editid1");
