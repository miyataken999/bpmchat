...
require_once("include/CATALOG_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "CATALOG_edit";
...
$page_layouts["CATALOG_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "CATALOG_list";
...
$page_layouts["CATALOG_list"] = $layout;
...
$keys = array();
$keys["CAT_UID"] = postvalue("editid1");
$keys["CAT_TYPE"] = postvalue("editid2");
