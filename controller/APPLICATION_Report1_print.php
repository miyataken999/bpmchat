...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "APPLICATION_Report1_rprint";
...
$page_layouts["APPLICATION_Report1_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=APPLICATION_Report1.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=APPLICATION_Report1.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
