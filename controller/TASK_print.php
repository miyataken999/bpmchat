...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "PROCESS_masterprint";
...
$page_layouts["PROCESS_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "TASK" );
