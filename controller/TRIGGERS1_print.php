...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "TABLES_masterprint";
...
$page_layouts["TABLES_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "TRIGGERS1" );
