...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "modx_site_content_print";
...
$page_layouts["modx_site_content_print"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "modx_site_templates_print";
$layout->blocks["top"] = array();
$layout->containers["pdf"] = array();
$layout->container_properties["pdf"] = array(  "print" => "none"  );
$layout->containers["pdf"][] = array("name"=>"printbuttons",
...
$layout->blocks["top"][] = "grid";
$page_layouts["modx_site_templates_print"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "modx_site_snippets_print";
$layout->blocks["top"] = array();
$layout->containers["pdf"] = array();
$layout->container_properties["pdf"] = array(  "print" => "none"  );
$layout->containers["pdf"][] = array("name"=>"printbuttons",
...
$layout->blocks["top"][] = "grid";
$page_layouts["modx_site_snippets_print"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "modx_site_htmlsnippets_print";
$layout->blocks["top"] = array();
$layout->containers["pdf"] = array();
$layout->container_properties["pdf"] = array(  "print" => "none"  );
$layout->containers["pdf"][] = array("name"=>"printbuttons",
...
$layout->blocks["top"][] = "grid";
$page_layouts["modx_site_htmlsnippets_print"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "modx_site_content_child_print";
$layout->blocks["top"] = array();
$layout->containers["pdf"] = array();
$layout->container_properties["pdf"] = array(  "print" => "none"  );
$layout->containers["pdf"][] = array("name"=>"printbuttons",
...
$layout->blocks["top"][] = "grid";
$page_layouts["modx_site_content_child_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "modx_site_content" );
