...
require_once("include/SEQUENCES_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "SEQUENCES_edit";
...
$page_layouts["SEQUENCES_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "SEQUENCES_list";
...
$page_layouts["SEQUENCES_list"] = $layout;
...
$keys = array();
$keys["SEQ_NAME"] = postvalue("editid1");
