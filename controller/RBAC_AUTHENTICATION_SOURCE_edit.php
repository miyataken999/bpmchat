...
require_once("include/RBAC_AUTHENTICATION_SOURCE_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "RBAC_AUTHENTICATION_SOURCE_edit";
...
$page_layouts["RBAC_AUTHENTICATION_SOURCE_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "RBAC_AUTHENTICATION_SOURCE_list";
...
$page_layouts["RBAC_AUTHENTICATION_SOURCE_list"] = $layout;
...
$keys = array();
$keys["AUTH_SOURCE_UID"] = postvalue("editid1");
