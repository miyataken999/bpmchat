...
require_once("include/ABE_REQUESTS_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "ABE_REQUESTS_edit";
...
$page_layouts["ABE_REQUESTS_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "ABE_REQUESTS_list";
...
$page_layouts["ABE_REQUESTS_list"] = $layout;
...
$keys = array();
$keys["ABE_REQ_UID"] = postvalue("editid1");
