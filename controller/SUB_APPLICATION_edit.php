...
require_once("include/SUB_APPLICATION_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "SUB_APPLICATION_edit";
...
$page_layouts["SUB_APPLICATION_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "SUB_APPLICATION_list";
...
$page_layouts["SUB_APPLICATION_list"] = $layout;
...
$keys["APP_PARENT"] = postvalue("editid2");
$keys["DEL_INDEX_PARENT"] = postvalue("editid3");
$keys["DEL_THREAD_PARENT"] = postvalue("editid4");
