...
require_once("include/APP_DOCUMENT_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "APP_DOCUMENT_edit";
...
$page_layouts["APP_DOCUMENT_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "APP_DOCUMENT_list";
...
$page_layouts["APP_DOCUMENT_list"] = $layout;
...
$keys = array();
$keys["APP_DOC_UID"] = postvalue("editid1");
$keys["DOC_VERSION"] = postvalue("editid2");
