...
$layout = new TLayout("login_bootstrap", "OfficeBlueWave", "MobileBlueWave");
$layout->version = 3;
...
$params["fb_error_code"] = postvalue("error_code");
$params["fb_state"] = postvalue("state");
$params["fb_code"] = postvalue("code");
$params["fb_error_reason"] = postvalue("error_reason");
