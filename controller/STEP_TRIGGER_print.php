...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "STEP_TRIGGER_print";
...
$page_layouts["STEP_TRIGGER_print"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "STEP_masterprint";
...
$page_layouts["STEP_masterprint"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "TRIGGERS_masterprint";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
$layout->container_properties["column"] = array(  );
$layout->containers["column"][] = array("name"=>"masterprintheader",
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["TRIGGERS_masterprint"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "TASK_masterprint";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
$layout->container_properties["column"] = array(  );
$layout->containers["column"][] = array("name"=>"masterprintheader",
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["TASK_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "STEP_TRIGGER" );
