...
require_once("include/USR_REPORTING_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "USR_REPORTING_edit";
...
$page_layouts["USR_REPORTING_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "USR_REPORTING_list";
...
$page_layouts["USR_REPORTING_list"] = $layout;
...
$keys["MONTH"] = postvalue("editid3");
$keys["YEAR"] = postvalue("editid4");
