...
require_once("include/SESSION_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "SESSION_edit";
...
$page_layouts["SESSION_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "SESSION_list";
...
$page_layouts["SESSION_list"] = $layout;
...
$keys = array();
$keys["SES_UID"] = postvalue("editid1");
