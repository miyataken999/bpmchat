...
require_once("include/CONFIGURATION_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "CONFIGURATION_edit";
...
$page_layouts["CONFIGURATION_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "CONFIGURATION_list";
...
$page_layouts["CONFIGURATION_list"] = $layout;
...
$keys = array();
$keys["CFG_UID"] = postvalue("editid1");
$keys["OBJ_UID"] = postvalue("editid2");
$keys["PRO_UID"] = postvalue("editid3");
$keys["USR_UID"] = postvalue("editid4");
$keys["APP_UID"] = postvalue("editid5");
