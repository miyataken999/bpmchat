...
require_once("include/TASK_USER_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "TASK_USER_edit";
...
$page_layouts["TASK_USER_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "TASK_USER_list";
...
$page_layouts["TASK_USER_list"] = $layout;
...
$keys = array();
$keys["TAS_UID"] = postvalue("editid1");
$keys["USR_UID"] = postvalue("editid2");
$keys["TU_TYPE"] = postvalue("editid3");
$keys["TU_RELATION"] = postvalue("editid4");
