...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "ROUTE_masterprint";
...
$page_layouts["ROUTE_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "CONTENT" );
