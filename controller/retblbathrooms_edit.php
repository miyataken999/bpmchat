...
require_once("include/retblbathrooms_variables.php");
...
$layout = new TLayout("edit_bootstrap_menu", "OfficeBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "retblbathrooms_edit";
...
$page_layouts["retblbathrooms_edit"] = $layout;
...
$layout = new TLayout("bootstrap31", "OfficeBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "retblbathrooms_list";
...
$page_layouts["retblbathrooms_list"] = $layout;
...
$keys = array();
$keys["BathroomsID"] = postvalue("editid1");
